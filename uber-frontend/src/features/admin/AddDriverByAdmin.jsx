...
import { addDriverByAdmin } from '../../api/adminAPI';
import { Form, Button, Container, Card, Row, Col, ProgressBar, Spinner, Alert } from 'react-bootstrap';
import { FaCar, FaUser, FaLock, FaMapMarkerAlt, FaPhone, FaEnvelope, FaIdCard, FaShieldAlt, FaUserPlus } from 'react-icons/fa';

const AddDriverByAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addDriverByAdmin(fixedForm);
...
export default AddDriverByAdmin;
